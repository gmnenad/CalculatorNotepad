...
namespace Mpfr.Native
{
    ...
    /// structure, and <a href="https://machinecognitis.github.io/Mpfr.Gmp/html/4609ac5e-5cf9-cd20-2fa9-8040101c165c.htm">mp_ptr</a>
    ...
    public class mpfr_t : mp_base
    {
        ...
        {
            Mpfr.Gmp.size_t length = /*sizeof(int) + sizeof(int) + sizeof(int)*/ 12U + (size_t)IntPtr.Size;
        ...
        /// ceil(<see cref="_mpfr_prec">_mpfr_prec</see> / <a href="https://machinecognitis.github.io/Mpfr.Gmp/html/f88c76a8-118a-5cbd-0df1-e30adcacb8ae.htm">mp_bits_per_limb</a>).
        ...
        public override IntPtr _mp_d_intptr
        {
            get
            {
                return Marshal.ReadIntPtr(Pointer, /*sizeof(int) + sizeof(int) + sizeof(int) + 4 byte PADDING !? */ 16);
            }
            set
            {
                Marshal.WriteIntPtr(Pointer, /*sizeof(int) + sizeof(int) + sizeof(int)  */ 16, value);
            }
        }
