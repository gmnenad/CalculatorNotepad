...
namespace Mpfr.Native
{
    ...
    /// <remarks>
    /// <para>
    /// The floating point functions accept and return exponents in the C type <see cref="mpfr_exp_t">mpfr_exp_t</see>.
    ...
    public struct mpfr_exp_t
    {
        ...
        /// <summary>
        /// The <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        public int Value;

        /// <summary>
        /// Creates a new <see cref="mpfr_exp_t">mpfr_exp_t</see>, and sets its <paramref name="value"/>.
        /// </summary>
        /// <param name="value">The value of the new <see cref="mpfr_exp_t">mpfr_exp_t</see>.</param>
        ...
        /// <summary>
        /// Converts a <see cref="Byte">Byte</see> value to an <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        /// <param name="value">A <see cref="Byte">Byte</see> value.</param>
        /// <returns>An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</returns>
        ...
        /// <summary>
        /// Converts a <see cref="UInt16">UInt16</see> value to an <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        ...
        /// <summary>
        /// Converts an <see cref="Int16">Int16</see> value to an <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="UInt32">UInt32</see> value to an <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        ...
        /// <summary>
        /// Converts an <see cref="Int32">Int32</see> value to an <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="UInt64">UInt64</see> value to an <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        ...
        /// <summary>
        /// Converts an <see cref="Int64">Int64</see> value to a <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to a <see cref="Byte">Byte</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to an <see cref="SByte">SByte</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to a <see cref="UInt16">UInt16</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to an <see cref="Int16">Int16</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to a <see cref="UInt32">UInt32</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to an <see cref="Int32">Int32</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to a <see cref="UInt64">UInt64</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Converts an <see cref="mpfr_exp_t">mpfr_exp_t</see> value to an <see cref="Int64">Int64</see> value.
        /// </summary>
        /// <param name="value">An <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        ...
        /// <summary>
        /// Gets the string representation of the <see cref="mpfr_exp_t">mpfr_exp_t</see>.
        /// </summary>
        /// <returns>The string representation of the <see cref="mpfr_exp_t">mpfr_exp_t</see>.</returns>
        ...
        /// <returns><c>True</c> if <paramref name="obj"/> is an instance of <see cref="mpfr_exp_t">mpfr_exp_t</see> and equals the value of this instance; otherwise, <c>False</c>.</returns>
        ...
        /// <summary>
        /// Returns a value indicating whether this instance is equal to a specified <see cref="mpfr_exp_t">mpfr_exp_t</see> value.
        /// </summary>
        /// <param name="other">A <see cref="mpfr_exp_t">mpfr_exp_t</see> value to compare to this instance.</param>
        ...
        /// </summary>
        /// <param name="value1">A <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
        /// <param name="value2">A <see cref="mpfr_exp_t">mpfr_exp_t</see> value.</param>
