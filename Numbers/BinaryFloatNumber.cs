...
namespace Numbers
{
    ...
    public class BinaryFloatNumber : IComparable<BinaryFloatNumber>
    {
        ...
        /// <summary>
        /// Convert to string in given (binary divisible) Base from UInt64 bits array. Highest bit in bits[len-1] is "1.", other bits are fraction. Exponent assume integer 'bits', so should be -63 for '1'
        /// </summary>
